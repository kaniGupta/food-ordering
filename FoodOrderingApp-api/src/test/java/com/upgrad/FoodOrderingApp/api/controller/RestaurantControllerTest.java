...
public class RestaurantControllerTest {
    ...
    public void shouldGetRestaurantDetailsForCorrectRestaurantId() throws Exception {
        ...
        when(mockRestaurantService.restaurantByUUID("someRestaurantId")).thenReturn(restaurantEntity);
    ...
    public void shouldGetRestaurantDetailsByGivenName() throws Exception {
        final RestaurantEntity restaurantEntity = getRestaurantEntity();
        when(mockRestaurantService.restaurantsByName("someRestaurantName")).thenReturn(Collections.singletonList(restaurantEntity));
    ...
    private ItemEntity getItemEntity() {
        ...
        itemEntity.setType(ItemType.NON_VEG.toString());

...
public class CustomerBusinessService {
    ...
    public CustomerAuthEntity login(final String authorization)
        ...
        final CustomerEntity customerEntity = customerEntityDao.getCustomerByContactNumber(contactNumber);
    ...
    public CustomerAuthEntity logout(final String accessToken) throws AuthorizationFailedException {
        final CustomerAuthEntity customerAuthEntity = customerEntityDao.getCustomerAuthToken(accessToken);
    ...
    public CustomerEntity update(final String accessToken, final CustomerEntity customerEntity) throws AuthorizationFailedException, UpdateCustomerException {
        ...
        final CustomerEntity updatedCustomerEntity = customerAuthEntity.getCustomer();
     ...
     */
    private boolean validateCustomerEntity(final CustomerEntity customerEntity) {
